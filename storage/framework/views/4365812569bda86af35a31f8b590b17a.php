...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.add-btn','data' => ['class' => 'float-btn btn-plus','href' => ''.e(route('client_prove_socials.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'float-btn btn-plus','href' => ''.e(route('client_prove_socials.create')).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
